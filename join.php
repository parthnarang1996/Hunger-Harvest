                           ...
                           <div class="widget-body">
                              <form action='' method='post'  enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="pwd" class="form-control" value="12345" placeholder="12345" disabled>
                                                   </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-actions">
                                        <center><input type="submit" name="submit" class="btn btn-success" value="save"></center><br>
                                    </div>
                              </form>
