					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO dishes(rs_id,title,slogan,price,img,r_price) VALUE('".$_POST['res_name']."','".$_POST['d_name']."','".$_POST['about']."','".$_POST['price']."','".$fnew."','".$_POST['r_price']."')";  // store the submited data ino the database :images
												mysqli_query($db, $sql); 
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="r_price" class="form-control" placeholder="$">
                                                   </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
