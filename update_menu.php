					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update dishes set rs_id='$_POST[res_name]',title='$_POST[d_name]',slogan='$_POST[about]',price='$_POST[price]',r_price='$_POST[r_price]',img='$fnew' where d_id='$_GET[menu_upd]'";  // update the submited data ino the database :images
												mysqli_query($db, $sql); 
                                ...
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Real Price </label>
                                                    <input type="text" name="price" value="<?php echo $roww['r_price'];?>"  class="form-control" placeholder="$">
                                                   </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <!--/row-->
                                            ...
                                            <!--/span-->
                                        <div class="row">
                                        <input type="text" name="res_name" value="<?php echo $_SESSION['rs_id'] ?>" hidden>
                                            </div>
